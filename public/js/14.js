                  ...
                  [
                    !_vm.$page.auth.user
                      ? [
                          _c(
                            "section",
                            { staticClass: "px-6 pb-12 mb-6 border-b" },
                            [
                              _c("header", { staticClass: "mb-6" }, [
                                _c(
                                  "h2",
                                  { staticClass: "text-lg mb-2 text-gray-600" },
                    ...
                    _c("section", { staticClass: "px-6 pb-12 mb-6 border-b" }, [
                      ...
                      _vm._v(" "),
                      _vm.$page.auth.user && _vm.hasStatus
                        ? _c(
                            "div",
                            {
                              staticClass:
